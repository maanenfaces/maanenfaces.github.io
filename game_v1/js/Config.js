export const DREAMLO_PUBLIC = "69458ce88f40bbcf805ef9d4";
export const DREAMLO_PRIVATE = "hs-2UxzkEE63Qe2M03wFnw54oKmXEjbE24PZxu_IlWYA";
...
export const SONG_STRUCTURE = [
    ...
    // VERSE 2 WARMUP: SLOWLY GETTING BACK INTO IT
    ...
    // BRIDGE 2
    { start: 304, end: 318, label: "BRIDE 2",          speed: 0.8, density: 0.03, effects: [], waveHeight: 0, curveStrength: 2, color: 0xffff00 },
    { start: 318, end: 332, label: "BRIDE 2 BUILD-UP", speed: 0.8, density: 0.03, effects: [], waveHeight: 0, curveStrength: 2, color: 0xffff00 },
